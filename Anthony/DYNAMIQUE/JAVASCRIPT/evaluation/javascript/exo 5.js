...
//  integration fonction et declaration des variables ------------------------------------------------------
{
    var Identité = /(^[a-zA-Zéèêëôœîïûüàáâæç-\s]+$)/;
    var mail = /(^[\w\.-]+@[a-z]+[\.]{1}[a-z]{2,3}$)/;
    var birth = /(^[0-9]{4}[\-]{1}[0-9]{2}[\-]{1}[[0-9]{2}$)/;
    var cp = /(^[0-9]{5}$)/;
    var adr = /(^[0-9]+[a-zA-Z-\s]+$)|^$/;
    var Localisation = /(^[a-zA-Zéèêëôœîïûüàáâæç-\s]+$)|^$/;

    //  integration des regex de declaratition d'attribut ---------------------------------------------------
